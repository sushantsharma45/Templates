struct mll {
    ...
    mll operator%(ll  m) const { return mll(num % m); }
    mll operator%(int m) const { return mll(num % m); }

    ll operator&(ll  m) const { return num & m; }
    ll operator&(int m) const { return num & m; }
    
    friend ll operator&(ll lhs, const mll& rhs){ return lhs & rhs.num; }
    friend ll operator&(int lhs, const mll& rhs){ return lhs & rhs.num; }
